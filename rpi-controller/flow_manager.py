...
class FlowManager:
    ...
    def process(self):
        ...
        self._log_throttle.reset("authorize_invalid_contract")
        ...
        if max_volume_ml <= 0 or price_per_ml_cents <= 0:
            self._log_throttled(
                ...
                level=logging.ERROR,
                interval_seconds=2.0,
                state=(max_volume_ml, price_per_ml_cents),
            )
        ...
        try:
            while self.hardware.is_card_present():
                ...
                if has_reached_pour_limit(total_volume_ml, max_volume_ml):
                    ...
                    total_volume_liters = max_volume_ml / 1000.0
                    progress_display.update(
                        total_volume_ml,
                        max_volume_ml=max_volume_ml,
                        estimated_cost_cents=calculate_price_cents(total_volume_ml, price_per_ml_cents),
                    )
