<script>
  ...
  const steps = [
    ...
    { title: '2. Операционный контроль', text: 'Проверяем состояние кранов и кег, снимаем риски пустых линий.', link: '#/taps'},
    { title: '3. Управление гостями', text: 'Показываем цикл клиента: создание, карта, пополнение.', link: '#/cards-guests'},
  ];
</script>
