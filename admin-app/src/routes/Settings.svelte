...
{#if !$roleStore.permissions.settings_manage}
  <section class="ui-card restricted">
    <h1>Настройки</h1>
    <p>Раздел с редкими конфигурационными действиями доступен только инженеру или владельцу.</p>
  </section>
{:else}
  <section class="page settings-page">
    <header class="page-header">
      <div>
        ...
        <h1>Конфигурация рабочего места и подключения</h1>
        <p>Здесь собраны только редкие изменения конфигурации: рабочее место, адрес backend и сервисные параметры точки. Операционный health и проблемы устройств остаются в разделе «Система».</p>
      </div>
      <a class="route-link" href="#/system">Открыть «Система»</a>
    </header>

    <section class="ui-card callout">
      <strong>Когда использовать этот раздел</strong>
      <p>Открывайте его при вводе новой точки, замене ПК/ридера, переносе admin-app на другой backend или перед инженерными изменениями конфигурации. Для текущих инцидентов, деградации устройств и sync-очередей переходите в «Система».</p>
    </section>
