...
const PERMISSIONS = {
  ...
  inventory_view: 'Просмотр раздела «Кеги и напитки» в read-only режиме без изменения каталога и инвентаря.',
  kegs_manage: 'Операционные действия по кегам: подключение/отключение и изменение физического инвентаря.',
  beverages_catalog_manage: 'Редактирование каталога напитков и guest-facing карточек.',
