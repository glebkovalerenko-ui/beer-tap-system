...
def create_card(
    ...
    _permission_guard: dict = Depends(security.require_permissions("cards_reissue_manage")),
...
def update_card_status(
    ...
    _permission_guard: dict = Depends(security.require_permissions("cards_block_manage")),
    db: Session = Depends(get_db),
):
