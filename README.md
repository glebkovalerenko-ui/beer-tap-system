...
[![Технологии: Docker, Python, Svelte](https://img.shields.io/badge/stack-Docker%20|%20Python%20|%20Svelte-blue)](https://shields.io/)
...
| **Интерфейс (Frontend)**| Svelte 5 | latest | Современный фреймворк для построения UI |
| | Tauri 2.0 | latest | Фреймворк для создания десктопных приложений |
