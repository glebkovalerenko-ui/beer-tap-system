...
├── admin-app/             # 🖥️ Лицо - Веб-интерфейс
...
- **Выбор Svelte 5 + Tauri 2.0:** Современный и производительный стек. Svelte 5 обеспечивает отличную производительность и небольшой размер бандла, а Tauri 2.0 позволяет создавать нативные десктопные приложения с веб-технологиями.
